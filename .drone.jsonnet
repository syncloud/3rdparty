...
[ 
    ...
    for item in [
        ...
        {project: "opendkim", image: "syncloud/build-deps-arm", arch: "arm"},
        {project: "opendkim", image: "syncloud/build-deps-amd64", arch: "amd64"},
        {project: "opendkim", image: "syncloud/build-deps-buster-arm64", arch: "arm64"},
