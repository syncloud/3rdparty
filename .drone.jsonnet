...
[ 
    ...
    for item in [
        ...
        {project: "dovecot", image: "syncloud/build-deps-arm", arch: "arm"},
        {project: "dovecot", image: "syncloud/build-deps-amd64", arch: "amd64"},
        {project: "dovecot", image: "syncloud/build-deps-buster-arm64", arch: "arm64"},
