...
${DIR}/build/dovecot/bin/doveadm.sh --version | grep "doveadm(init)"
${DIR}/build/dovecot/libexec/dovecot/auth.sh | grep "auth(init)"
...
${DOVECOT}/libexec/dovecot/auth | grep "auth(init)"
