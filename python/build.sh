...
./Configure --prefix=${OPENSSL} --openssldir=/usr/lib/ssl shared no-idea no-mdc2 no-rc5 no-zlib enable-tlsext no-ssl2 no-ssl3 enable-unit-test no-ssl3-method enable-rfc3779 enable-cms 
make
make install
