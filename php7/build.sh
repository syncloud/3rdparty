...
apt update
apt install -y libonig-dev cmake libldb-dev libldap2-dev libsasl2-dev libfreetype6-dev liblqr-1-0-dev libfftw3-dev libjbig-dev libtiff5-dev libwebp-dev 
